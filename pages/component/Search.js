...
function Search({onSearch}) {//props를 받을 자식컴포넌트는 Search {onSearch} = props
  ...
  const handleSearchClick = () => {
    ...
    //search함수의 인자와 똑같이 받아와야 한다.
    onSearch({departure:"ICN", destination:textDestination}); //props.onSearch 해도됨
  };
